...
APlayerEnd::APlayerEnd()
{
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ParticleAsset(TEXT("ParticleSystem'/Game/dungeonCrawler/Prefab_BluePrints/Tiles/P_ky_magicCircle1.P_ky_magicCircle1'"));
